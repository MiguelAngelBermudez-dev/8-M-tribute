...
<body class="bg-gray-100">
    <div class="parent">
        <header>
            ...
            <div class="bg-violet-600 relative   flex items-center  n justify-center overflow-hidden z-50 ">
                    ...
                    <div class="flex flex-col items-center justify-between lg:flex-row py-16">
                        <div class=" relative ">
                            <div class="lg:max-w-xl lg:pr-5 relative z-40">
                                ...
                                <h2 class="mb-6 max-w-lg text-5xl font-light leading-snug tracking-tight text-g1 sm:text-7xl sm:leading-snug">
                                    El 8-M 
                                    <span class="my-1 inline-block border-b-8 border-g4 bg-white px-4 font-bold text-g4 animate__animated animate__flash">se sale</span>
                                </h2>
                                <p class="text-base text-gray-700">El Día Internacional de la Mujer, antes denominado Día Internacional de la Mujer Trabajadora.</p>
                                <div class="mt-10 flex flex-col items-center md:flex-row">
                                    <a href="/" class="mb-3 inline-flex h-12 w-full items-center justify-center rounded bg-green-600 px-6 font-medium tracking-wide text-white shadow-md transition hover:bg-blue-800 focus:outline-none md:mr-4 md:mb-0 md:w-auto">
                                        View More</a>
                                    <a href="/" aria-label="" class="group inline-flex items-center font-semibold text-g1">Unete a nuestra lucha
                        ...
                        <div class="relative hidden lg:ml-32 lg:block lg:w-1/2">
                            ...
                            <div class="abg-orange-400 mx-auto w-fit overflow-hidden rounded-[6rem] rounded-br-none rounded-tl-none">
                                <img src="media/Programatica_300x250 VLC.jpg">
                            </div>
                        </div>
                    </div>
                </div>
