...
<body class="bg-gray-100">
            ...
            <div class="hidden w-full md:block md:w-auto" id="navbar-solid-bg">
                <ul class="flex flex-col font-medium mt-4 rounded-lg bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-transparent dark:bg-gray-800 md:dark:bg-transparent dark:border-gray-700">
                    <ul class="flex flex-col font-medium mt-4 rounded-lg bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-transparent dark:bg-gray-800 md:dark:bg-transparent dark:border-gray-700">
                        ...
                        <li>
                            <a href="#" class="block py-2 px-3 md:p-0 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent">Hedwing Eva Maria Kiester</a>
                        </li>
                        <li>
            ...
            <div class="flex flex-wrap items-center">
                <div class="w-10/12 md:w-6/12 lg:w-4/12 px-12 md:px-4 mr-auto ml-auto -mt-78">
                    <div class="relative flex flex-col min-w-0 break-words bg-white w-full mb-6 shadow-lg rounded-lg bg-pink-500">
                        <img alt="Ada Lovelace" src="https://upload.wikimedia.org/wikipedia/commons/thumb/d/d8/Hedy_Lamarr_in_The_Heavenly_Body_1944.jpg/330px-Hedy_Lamarr_in_The_Heavenly_Body_1944.jpg" class="w-full align-middle rounded-t-lg">
                        <blockquote class="relative p-8 mb-4 bg-purple-900">
                            ...
                            <h4 class="text-xl font-bold text-white">
                                Hedwig Eva Maria Kiesler en 1930.
                            </h4>
                            <br>
                        </blockquote>
                    </div>
                            ...
                            <div class="relative flex flex-col mt-4">
                                <div class="px-4 py-5 flex-auto">
                                    ...
                                    <p class="mb-4 text-blueGray-500">
                                        9 de noviembre de 1914 Ver y modificar los datos en Wikidata
                            ...
                            <div class="relative flex flex-col min-w-0">
                                <div class="px-4 py-5 flex-auto">
                                    ...
                                    <h6 class="text-xl mb-1 font-semibold">
                                        Fallecimiento </h6>
                                    <p class="mb-4 text-blueGray-500">
                                        19 de enero de 2000 Ver y modificar los datos en Wikidata (85 años)
                        ...
                        <div class="w-full md:w-6/12 px-4">
                            <div class="relative flex flex-col min-w-0 mt-4">
                                <div class="px-4 py-5 flex-auto">
                                    ...
                                    <h6 class="text-xl mb-1 font-semibold">Estudios</h6>
                                    <p class="mb-4 text-blueGray-500">
                                    carrera cinematográfica.(No terminó sus estudios universitarios, pero asistió a la Universidad de Viena y a la Academia de Artes Escénicas de Berlín.)
                                    </p>
                                </div>
                            </div>
                            <div class="relative flex flex-col min-w-0">
                                <div class="px-4 py-5 flex-auto">
                                    ...
                                    <p class="mb-4 text-blueGray-500">
                                    Actriz, inventora, autobiógrafa, guionista, actriz de cine, productora de cine, música, modelo y animadora                                     </p>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <script>
        const cargar = () => {
            ...
            //ENLACE TXT
            xhr.open("GET", "bbdd/eva.txt", true);
            //manejo de la carga
            xhr.onload = function() {
                if (this.status == 200) {
        ...
        const cargar2 = () => {
            ...
            var xhr = new XMLHttpRequest();
            //ENLACE TXT
            xhr.open("GET", "bbdd/eva2.txt", true);
            //manejo de la carga
            xhr.onload = function() {
                if (this.status == 200) {
                    var contenido = xhr.responseText;
