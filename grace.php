            ...
            <div class="flex flex-wrap items-center">
                <div class="w-10/12 md:w-6/12 lg:w-4/12 px-12 md:px-4 mr-auto ml-auto -mt-78">
                    <div class="relative flex flex-col min-w-0 break-words bg-white w-full mb-6 shadow-lg rounded-lg bg-pink-500">
                        <img alt="Grace Hopper" src="https://upload.wikimedia.org/wikipedia/commons/thumb/9/98/Commodore_Grace_M._Hopper%2C_USN_%28covered%29_head_and_shoulders_crop.jpg/800px-Commodore_Grace_M._Hopper%2C_USN_%28covered%29_head_and_shoulders_crop.jpg" class="w-full align-middle rounded-t-lg">
                        ...
                        <div class="w-full md:w-6/12 px-4">
                            <div class="relative flex flex-col min-w-0 mt-4">
                                <div class="px-4 py-5 flex-auto">
                                    ...
                                    <h6 class="text-xl mb-1 font-semibold">Educada en</h6>
                                    <p class="mb-4 text-blueGray-500">
                                        Wardlaw-Hartridge School (1923-1924)
                                        Vassar College (Grado en Matemáticas y Física; 1924-1928)
                                        Universidad Yale (Maestría; 1928-1930)
                                        Universidad Yale (Ph.D. en Matemáticas; hasta 1934).
                                    </p>
                                </div>
                            </div>
                            <div class="relative flex flex-col min-w-0">
                                <div class="px-4 py-5 flex-auto">
                                    ...
                                    <p class="mb-4 text-blueGray-500">
                                    Matemática, oficial naval, informática teórica, profesora de universidad, programadora y física.
                                    </p>
                                </div>
                            </div>
                        </div>
...
<script>
  ...
  const cargar2 = () => {
    ...
    var xhr = new XMLHttpRequest();
    //ENLACE TXT
    xhr.open("GET", "bbdd/hopper2.txt", true);
    //manejo de la carga
    xhr.onload = function () {
      if (this.status == 200) {
        var contenido = xhr.responseText;
